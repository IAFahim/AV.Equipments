...
Equipment and inventory management system for character gear and item slots.
...
```json
"com.av.equipments": "https://github.com/IAFahim/AV.Equipments.git"
```

Or install via Git URL in Unity Package Manager:
1. Open Unity Package Manager (Window > Package Manager)
2. Click the + icon > Add package from git URL
3. Enter: `https://github.com/IAFahim/AV.Equipments.git`
...
Add components from the `AV Equipments` package to your GameObjects via the Component menu:
`Component > AV > Equipments > [Component Name]`

For detailed usage instructions, see the [Samples](Samples~) included with this package.

## API Documentation

For complete API reference and documentation, visit: https://github.com/IAFahim/AV.Equipments
...
For issues and questions, please use the [GitHub Issues](https://github.com/IAFahim/AV.Equipments/issues) page.
